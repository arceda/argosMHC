...
model_name = "/M2/ArgosMHC_models/checkpoints/tape_c3/checkpoint-200000"
...
test_dataset = DataSetLoaderTAPE("/M2/ArgosMHC_models/dataset/hlab/hlab_test.csv", max_length=seq_length)
